...
import Multitasking from "../assets/Multitasking.gif";
    ...
    <>
      <ThemeProvider theme={theme}>
        <div style={{ height: "100vh" }}>
          <Grid
            container
            sx={{ display: "flex", height: "10vh", backgroundColor: "#0E131F" }}
          >
            <Grid
              container
              sx={{
          ...
          <Grid container height="80vh" component="main">
            ...
            >
              <Typography
                ...
                textAlign="center"
              >
                Organize seu <br /> trabalho e vida, finalmente.
              </Typography>
              ...
              >
                ...
                TaskedTask App. O gerenciador e aplicativo <br /> de lista de
                tarefas nº 1 do mundo.
              </Typography>
            ...
            >
              <Image src={Multitasking} alt="Multitask" />
            </Grid>
          </Grid>
          <Grid component="footer" height="10vh">
            <Box
              display="flex"
              alignItems="end"
              justifyContent="end"
